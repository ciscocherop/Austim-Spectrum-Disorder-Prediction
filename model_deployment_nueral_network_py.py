# -*- coding: utf-8 -*-
"""Model-deployment-Nueral Network.py

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1bzm-H2dL2QnaZHTPns1MOcUBN_PsCDCT
...
# Load model & scaler
scaler = "/content/scaler_nn.pkl"
model = "/content/neural_network_asd_model.keras"
...
"""First, I'll write the Streamlit application code to a file named `app.py`."""
...
"""Now that `app.py` is created, I will run the Streamlit application."""
